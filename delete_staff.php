...
<body>
    <div class="banner">
        ...
        <div class="content">
            <h2>Enter the required detail to delete staff</h2><br>
            <div>
                <form style="text-align: center" action="" method="post">
                  <br>
                 Staff Id : <input type = "text" name = "sid" required></input> <br>
                <br><br>
        ...
        <?php
          ...
          if(isset($_POST['submit'])){
            ...
            try {
              ...
              $str =  "DELETE FROM fusionfit360.Staff WHERE Staff_id = '$sid'";
              $conn->exec($str);
