...
<div class="banner" >
  <div class="slider" >
      <img src="images/diet_bg.jpg" id="slideImg">
  </div>
  <div class="overlay"> 
    <div id="navdiv">
  ...
  <div style="display: flex;margin: 40px 0 0 0;">
      ...
      Specialized service center that provides personalized diet plans tailored to individual health and fitness goals. It offers nutritional guidance, meal planning and ongoing support to help clients achieve optimal wellness. By focusing on balanced, sustainable eating habits, the studio empowers users to improve their health and maintain a healthy lifestyle.
	  	</p>
  	</div>
    ...
    if(isset($_POST['submit'])){
        ...
        if($query == "fee"){
            ...
            try {
              ...
              //----------------------------------------
              $stmt = $conn->query("SELECT fee FROM fusionfit360.Department where did = 3");
    	...
    	if($query == "facility"){
            ...
            try {
              ...
              //----------------------------------------
              $stmt = $conn->query("SELECT * FROM fusionfit360.Facility where did = 3");
